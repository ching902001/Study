...
"""
https://medium.com/@gk_/equity-screening-using-python-backtrader-part-2-of-2-71b956f8784a
"""
...
cookies = {'sessionid': 'zw53stv84dn2am47ag5prl0uvh31joz3'}
...
for ticker in ETFs:
    ...
    url = "https://api.tiingo.com/tiingo/daily/%s/prices?startDate=%s&endDate=%s" % (ticker, startDate, endDate)
...
"""
Set up our workspace variables
"""
...
"""
Optimize the Moving Average Period
"""
